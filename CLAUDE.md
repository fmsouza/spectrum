...
- `@spectrum/pty` — terminal/PTY lifecycle: TerminalManager + PtySpawner SPI + pure terminal protocol (depends on types, utils, logger; native addon @homebridge/node-pty)
